...
Route::group(['middleware' => ['language']], function () {
    Route::group([ 'prefix' => 'company','middleware' => 'company','as' => 'company.'], function () {
        ...
        Route::get('rates-company', [App\Http\Controllers\Company\CompanyController::class, 'listCompanyRate'])->name('rates.listCompanyRate');
        ...
        Route::post('update-profile', [App\Http\Controllers\Company\ProfileController::class, 'updateProfile'])->name('profile.update');
        ...
        Route::post('update-password', [App\Http\Controllers\Company\ProfileController::class, 'updatePassword'])->name('profile.update_password');
